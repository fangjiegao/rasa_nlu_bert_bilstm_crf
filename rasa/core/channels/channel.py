...
def register(
    ...
    # async def handler(message: UserMessage) -> None:  # gfj
    #    await app.agent.handle_message(message)  # gfj

    async def handler(message: UserMessage):
        return await app.agent.parse_message_using_nlu_interpreter(message)
