...
from custom.nlu.extractors.bert_lstm_crf_extractor.utils import get_max_len, pad_sequences_one
from custom.nlu.extractors.bert_lstm_crf_extractor.base_model import BiLstmCrfForBertModel, ORTHER_TAG
...
class BiLstmCrfForBert(EntityExtractor):
    name = 'bert_bilstm_crf_v2'
    ...
    def train(self, training_data: TrainingData,
              ...
              **kwargs: Any, ) -> None:
        self.model, self.label2tag = BiLstmCrfForBertModel.instance(self.component_config)
    ...
    def process(self, message: Message, **kwargs: Any) -> None:
        self.model, _ = BiLstmCrfForBertModel.instance(self.component_config)

        self.label2tag = self.component_config.get("label2tag")
        dataset = self._create_dataset_for_process(message, False)
        label_id_list = self.model.predict(dataset)
    ...
    def load(cls, meta: Dict[Text, Any],
             ...
             cached_component: Optional["BiLstmCrfForBert"] = None,
             **kwargs: Any
             ) -> "BiLstmCrfForBert":
    ...
    def _create_dataset(self,
        ...
        for example in examples:
            ...
            if istarin is True:
                ...
                labels = []
            features_array = pad_sequences_one(features_array, maxLen)
